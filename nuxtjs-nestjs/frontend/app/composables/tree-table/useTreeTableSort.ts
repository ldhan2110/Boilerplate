...
export interface UseTreeTableSortOptions {
...
export interface UseTreeTableSortReturn {
...
export function useTreeTableSort(options: UseTreeTableSortOptions): UseTreeTableSortReturn {
