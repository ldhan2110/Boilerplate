...
export interface UseTreeTableColumnDragOptions {
  columns: Ref<ColumnDef[]>
  hasColumnGroups: ComputedRef<boolean>
  headerRows: ComputedRef<HeaderCell[][]>
  reorderableColumns: Ref<boolean>
  columnsApi: UseTreeTableColumnsReturn
}

export interface UseTreeTableColumnDragReturn {
...
export function useTreeTableColumnDrag(options: UseTreeTableColumnDragOptions): UseTreeTableColumnDragReturn {
